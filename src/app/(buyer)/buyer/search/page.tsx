...
function BookingModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      // No payment happens here, escrow mode or not — payment is only ever
      // collected later, when there's actual work to pay for (Accept Work or
      // Accept Milestone). See services/buyer/booking.service.js.
